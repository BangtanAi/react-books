...
function CartItem({ id, name, imagePath, author, price, count }) {
    ...
    return (
      <div className="cart-item">
        <div className="cart-item__left">
          <img src={imagePath} className="cart-item__img" alt={name} />
        ...
        <div className="cart-item__center">
          <button className="cart-minus" onClick={onMinusItem}>
            <svg
              width="32"
              height="32"
              viewBox="0 0 32 32"
          ...
          <span>{count}</span>
          <button className="cart-plus" onClick={onAddItem}>
            <svg
              width="32"
              height="32"
              viewBox="0 0 32 32"
        ...
        <div className="cart-item__right">
          <p className="cart-price">{price * count} тг</p>
          <button className="delete-item" onClick={onRemoveItem}>
            <svg
              width="32"
              height="32"
              viewBox="0 0 32 32"
